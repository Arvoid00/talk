...
export default function ChatLayout({
  ...
  return (
    <>
      ...
      <div className="lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col hidden h-screen">
        <Sidebar
          profileOptions={profileOptions}
          onSignOut={signOut}
          isOpen={sidebarOpen}
      ...
      <div className="sm:px-6 sticky top-0 z-40 flex items-center gap-x-6 border-b p-4">
        <button
          type="button"
        ...
        <div className="text-sm flex-1 font-semibold leading-6">
          <Link href="/">Chat</Link>
        </div>
        <DropdownMenu>
            ...
            <Button variant="ghost" className="flex rounded-full p-0">
              {user?.user_metadata.avatar_url ? (
                <Image
                  height={60}
                  width={60}
                  className="ring-zinc-100/10 h-8 w-8 select-none rounded-full ring-1 transition-opacity duration-300 hover:opacity-80"
                  src={
                    user?.user_metadata?.avatar_url
      ...
      <main className="bg-muted/50 lg:pl-72 flex h-full flex-1 flex-col">
        <div>{children}</div>
      </main>
    </>
  )
  ...
  return (
    <>
      <div className="flex h-full flex-col overflow-y-hidden border-r bg-white dark:bg-black">
        <div className="flex items-center justify-between border-b py-4 pl-4 pr-3">
          ...
          <div className="flex">
            <Button
              ...
              className="lg:block hidden px-2"
              variant={'ghost'}
            >
        ...
        <div className="lg:flex hidden h-16 items-center border-t">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="text-sm flex h-full w-full items-center justify-start gap-x-2 rounded-none px-6 py-3 text-left focus:outline-none"
              >
                {user?.user_metadata.avatar_url ? (
                  <Image
                    height={60}
