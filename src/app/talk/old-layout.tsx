...
export default function Layout({ children }: any) {
  ...
  return (
    <div className="flex h-screen bg-gray-200">
      <div
        className={`lg:hidden fixed inset-0 z-20 bg-black opacity-50 transition-opacity ${
          isOpen ? 'block' : 'hidden'
        }`}
      ...
      <div
        className={`lg:static lg:inset-0 lg:translate-x-0 flex min-h-screen flex-col overflow-x-hidden transition duration-300${
      ...
      <div className="lg:flex lg:items-center lg:justify-center grow bg-gray-200 p-10">
        {children}
      </div>
    </div>
  )
