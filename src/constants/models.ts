...
export const models: Model<ModelType>[] = [
  {
    id: `gpt-4`,
    name: `gpt-4`,
    description: `Improves on GPT-3.5 and can understand and generate natural language or code. Optimized for chat but works well for traditional completions tasks.`,
    type: `OpenAI`,
    tokens: `8,192 tokens`,
    strengths: `Improved language and code understanding, optimized for chat and traditional completions`
  },
  {
    id: `gpt-4-0613`,
    name: `gpt-4-0613`,
    description: `Snapshot of gpt-4 from June 13th 2023 with function calling data. This model will not receive updates, and will be deprecated 3 months after a new version is released.`,
    type: `OpenAI`,
    tokens: `8,192 tokens`,
  ...
  },
  {
    id: `gpt-4-32k-0613`,
    name: `gpt-4-32k-0613`,
    description: `Snapshot of gpt-4-32 from June 13th 2023. This model will not receive updates, and will be deprecated 3 months after a new version is released.`,
    type: `OpenAI-Long`,
    tokens: `32,768 tokens`,
  ...
  },
  {
    id: `claude-1`,
    name: `claude-1`,
    description: `Claude's first model, ideal for a wide range of more complex tasks.`,
    type: `Anthropic`,
    tokens: `8k tokens`,
    strengths: `Unsure`
  },
  {
    id: `claude-2`,
    name: `claude-2`,
    description: `Anthropic's largest model, ideal for a wide range of more complex tasks. Superior performance on tasks that require complex reasoning`,
    type: `Anthropic`,
    tokens: `8k tokens`,
    strengths: `Unsure`
  },
